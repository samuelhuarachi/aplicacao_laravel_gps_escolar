        ...
        <div class="col-md-12">
            ...
            <div class="row">
                @if(count($user->vehicles) == 0)
                    <div class="col-md-12">
                        <p>Nenum veículo cadastrado no momento. Clique no botão acima para adicinar seu primeiro veículo.</p>
                    </div>
                @else
                        ...
                        <div class="col-md-4">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <a href="{{ route('admin.vehicle.edit', $vehicle->id) }}"><b>{{ $vehicle->placa }}</b> <i class="fas fa-shuttle-van"></i></a>
            ...
            {!! Form::open(['route' => 'admin.vehicle.new', 'class' => 'form', 'method' => 'post']) !!}
                <div class="modal-body">
                        <p class="text-primary">
                            * Você paga pelos dias que utliza. Seu plano
                            atual é R$ {{ $user->payment }} por mês por veículo ativo.
                            <br>Todo dia 10
                            será gerada uma fatura, que poderá ser paga por cartão, ou boleto.
                        </p>
